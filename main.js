...
class UI {
    ...
    setCartValues(cart) {
        ...
        cartItemsCounter.innerText = itemsTotal;
    }
    ...
    setupAPP() {
        ...
        navCartBtn.addEventListener("click", this.showCart);
    ...
    clearCart() {
        let cartItemsCounter = cart.map(item => item.id);
        cartItemsCounter.forEach(id => this.removeItem(id));
